...
const ManageTables: FC = ({}) => {
  ...
  return (
    <div>
      ...
      <div className="p-4">
        <div className="draggable-items w-1/3">
          {newTables && newTables.map((table) => <span>{table.name}</span>)}
    ...
    <!-- <div className="matching-pair">
      <span className="label">Codepen</span><span className="droppable" data-brand="codepen"></span>
    </div> --> */}
        </section>
      </div>
    </div>
